...
function review_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Review Entries', 'Post Type General Name', 'mtd_new' ),
		'singular_name'         => _x( 'Review Entry', 'Post Type Singular Name', 'mtd_new' ),
		'menu_name'             => __( 'Review Entries', 'mtd_new' ),
		'name_admin_bar'        => __( 'Review Entries', 'mtd_new' ),
		'archives'              => __( 'Review', 'mtd_new' ),
		'attributes'            => __( 'Item Attributes', 'mtd_new' ),
		'parent_item_colon'     => __( 'Parent Item:', 'mtd_new' ),
		'all_items'             => __( 'All Items', 'mtd_new' ),
		'add_new_item'          => __( 'Add New Item', 'mtd_new' ),
	...
	$args = array(
		'label'                 => __( 'Review Entry', 'mtd_new' ),
		'description'           => __( 'Review Entries', 'mtd_new' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'revisions', 'custom-fields' ),
		'hierarchical'          => false,
		'public'                => true,
...
function review_genres() {

	$labels = array(
		'name'                       => _x( 'Review Genres', 'Taxonomy General Name', 'newmtd' ),
		'singular_name'              => _x( 'Review Genre', 'Taxonomy Singular Name', 'newmtd' ),
		'menu_name'                  => __( 'Review Genre', 'newmtd' ),
		'all_items'                  => __( 'All Review Genres', 'newmtd' ),
		'parent_item'                => __( 'Parent Review Genre', 'newmtd' ),
		'parent_item_colon'          => __( 'Parent Review Genre:', 'newmtd' ),
		'new_item_name'              => __( 'New Review Genre', 'newmtd' ),
		'add_new_item'               => __( 'Add New Review Genre', 'newmtd' ),
		'edit_item'                  => __( 'Edit Review Genre', 'newmtd' ),
		'update_item'                => __( 'Update Review Genre', 'newmtd' ),
		'view_item'                  => __( 'View Review Genre', 'newmtd' ),
		'separate_items_with_commas' => __( 'Separate items with commas', 'newmtd' ),
		'add_or_remove_items'        => __( 'Add or remove items', 'newmtd' ),
		'choose_from_most_used'      => __( 'Choose from the most used', 'newmtd' ),
		'popular_items'              => __( 'Popular Items', 'newmtd' ),
...
add_action( 'init', 'review_genres', 0 );
